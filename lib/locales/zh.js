...
`,
  ...
  // ── lib/import-app.js ──────────────────────────────
  import: {
    usage: "用法: openyida import <file> [name]",
    example1: "示例: openyida import ./yida-export.json",
    example2: '      openyida import ./yida-export.json "质量追溯系统（生产环境）"',
    title: "  openyida import - 宜搭应用导入工具",
    import_file: "\n  导入文件: {0}",
    step_read_file: "\n📂 Step 1: 读取导出文件",
    file_not_found: "  ❌ 文件不存在: {0}",
    parse_failed: "  ❌ 解析导出文件失败: {0}",
    invalid_format: "  ❌ 导出文件格式无效，请使用 openyida export 生成",
    migration_suffix: "（迁移）",
    read_ok: "  ✅ 读取成功，共 {0} 个表单",
    source_app_id: "  源应用 ID: {0}",
    target_app_name: "  目标应用名: {0}",
    step_create_app: "\n📦 Step 3: 创建新应用",
    app_created: "  ✅ 新应用已创建: {0}",
    step_rebuild_forms: "\n🔨 Step 4: 重建表单页面",
    migrating: "\n  正在迁移: {0} ({1})",
    blank_form_created: "    ✅ 空白表单已创建: {0}",
    create_form_failed: "    ❌ 创建表单失败: {0}",
    schema_empty: "    ⚠️  Schema 内容为空，跳过",
    schema_empty_msg: "Schema 内容为空",
    save_schema_failed: "    ❌ 保存 Schema 失败: {0}",
    schema_saved: "    ✅ Schema 已保存",
    config_failed: "    ⚠️  配置更新失败（Schema 已保存）: {0}",
    config_updated: "    ✅ 表单配置已更新",
    step_write_report: "\n📄 Step 5: 写入迁移报告",
    report_written: "  ✅ 迁移报告已写入: {0}",
    done: "  ✅ 迁移完成！",
    new_app_id: "  新应用 ID:   {0}",
    new_app_name: "  新应用名称:  {0}",
    app_url: "  访问地址:    {0}",
    success_count: "  成功迁移:    {0} 个表单",
    fail_count: "  失败/跳过:   {0} 个表单",
    report_path: "  迁移报告:    {0}",
    notice_label: "\n  ⚠️  注意事项：",
    notice_association: "  - 关联表单（associationFormField）的跨表单引用需根据迁移报告手动更新",
    notice_custom_page: "  - 自定义页面需使用 openyida publish 单独重新发布",
    create_app_error: "创建应用失败",
    create_form_error: "创建表单失败",
  },
