...
```json
{"success":true,"appType":"APP_OGGKOOIHURKNCLFICN3J","appName":"考勤管理","url":"{base_url}/APP_OGGKOOIHURKNCLFICN3J/admin"}
```
...
```json
{
  "content": "APP_OGGKOOIHURKNCLFICN3J",
  "success": true
}
```
