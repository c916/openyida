---
name: yida
description: 宜搭自定义页面开发技能，包含宜搭表单 JS API 调用、JSX 组件开发规范、代码编译与 Schema 部署。
---
...
| `formUuid` | 表单 ID | `FORM-520F9514C72A4A7DA0793ED67E5BC9DE83SL` |
| `源文件路径` | 源码文件路径 | `src/index.js` |
...
| **yida-publish** | 编译源码 + 构建 Schema + 发布到宜搭 | `node .claude/skills/yida-publish/scripts/publish.js <appType> <formUuid> <源文件路径>` |
...
```bash
node .claude/skills/yida-publish/scripts/babel-transform/transform.js <源文件路径>
```
